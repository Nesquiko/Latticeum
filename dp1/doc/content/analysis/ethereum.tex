\chapter{Ethereum}\label{chapter:ethereum}
...
\section{Consensus}\label{sec:ethereum_consensus}
...
requests a bundle of transactions from the execution layer \ref{sec:ethereum_execution},
...
\section{Execution}\label{sec:ethereum_execution}

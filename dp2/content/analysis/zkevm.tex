...
% TODO IVC instantiation with folding scheme
To make the interaction between
$P$ and $V$ non-interactive with Fiat-Shamir heuristic \cite{FiatShamir}, $P$ must also provide
proof that it was used correctly. And also, $P$ needs to prove that

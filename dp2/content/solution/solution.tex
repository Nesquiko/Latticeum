...
detailing how 32 bit integer arithmetic is arithmetized into the Goldilocks extension
field elements required by lattice schemes using CCS \cite{CCS}. Finally, the recursive

...
\newcommand{\FIITthesis}[0] {Progress report on DP2 solution}
\newcommand{\FIITthesisSK}[0] {Priebežná správa o riešení DP2}
...
\newcommand{\FIITdate}[0] {January 2026}
\newcommand{\FIITdateSK}[0] {Január 2026}
...
\newcommand{\FIITsignDate}[0] {1.1.2026}

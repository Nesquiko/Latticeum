...
size figures should be interpreted only as approximate. For Nexus, the table
describes the current 3.0.
...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{@{}l>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X@{}}
		...
		\bottomrule
	\end{tabularx}
	\caption{Comparison of selected zkVMs relevant to this thesis. EthProofs hardware and proving-time entries are shown where publicly available; the architectural rows summarize the currently documented proof stacks.}

...
SP1, and ZKsync Airbender. Table~\ref{tab:zkvm-benchmarks-v2} compares the
wall-clock time of the proving and the peak RAM usage.
...
systems. Pico and SP1 complete the proof much faster, and Airbender is also
significantly faster in time, although it uses substantially more memory.

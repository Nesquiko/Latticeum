...
\begin{itemize}
	...
	\item \textbf{LatticeFold\footnote{\url{https://github.com/NethermindEth/latticefold}}:} The core folding mechanism is based on the
	      ...
	      verifier logic. It is the primary component of the IVC loop,
	      enabling the recursive accumulation of execution steps.

	\item \textbf{Cyclotomic-rings\footnotemark[\value{footnote}]:} From the same source as LatticeFold crate,
	...
	\item \textbf{REVM\footnote{\url{https://github.com/bluealloy/revm}}:} Used as a guest program in the ZkVM which validates an Ethereum block.
\end{itemize}

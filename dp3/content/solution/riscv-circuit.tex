...
the transition function of the RISC-V VM according to the RISC-V ISA \cite{RISCV, RISCVUnprivileged}.
...
Each memory event is constrained to match the executed instruction; only global
read-over-write consistency is deferred.

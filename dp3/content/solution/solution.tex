...
elements required by LatticeFold using CCS \cite{CCS}. Finally, the recursive
mechanism $F'$ is defined (\ref{sec:ivc}), outlining
how IVC \cite{ValiantIVC} is enforced to prove the integrity of long running
computations. The chapter concludes with the design of the final wrapping
SNARK (\ref{sec:wrapping_snark_design}), which compresses the final folded
artifacts into a succinct proof suitable for external verification.
...
\input{content/solution/wrapping-snark.tex}

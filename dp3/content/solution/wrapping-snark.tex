...
wrapper is therefore to compress them into a single succinct proof $\pi_{final}$.
...
The witness of the wrapper contains the same algebraic objects that
appear at the end of the IVC process: accumulator, folding witness
...
degrees, which suggests that a future fully implemented could plausibly

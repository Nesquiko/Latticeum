...
\usepackage{xcolor}
\usepackage{lipsum}
% latexmk writes auxiliary files into latex-builds, so minted must look there too.
\usepackage[outputdir=latex-builds]{minted}
\usepackage{tikz}
\usetikzlibrary{babel, shapes.geometric, arrows.meta, positioning, calc, fit, decorations.pathreplacing, patterns, backgrounds}
\usepackage{tocloft}
\usepackage{amsfonts}
\usepackage{amsmath}
\usepackage{caption}

...
Základný benchmark bol vykonaný na programe \texttt{fibonacci}. V optimalizovanej
binárke kompilátor výsledok 100. Fibonacciho čísla fakticky materializoval ako
konštantu, takže beh nemeral plných 100 iterácií, ale krátku vykonávaciu stopu.
Pri tomto behu vznikla stopa dlhá 16 inštrukcií a zaznamenali sa 2 pamäťové
operácie. Celkový čas skladania dosiahol 688,24 sekundy. Už tento jednoduchý
príklad ukázal, že aktuálny prototyp je výrazne pomalší než moderné ZkVM
riešenia.
...
založeným na \texttt{REVM}. Beh trval približne 9 hodín a 29 minút a nakoniec sa
zastavil kvôli chybe pri spracovaní inštrukcie, no počas behu sa IVC reťazec ďalej
overoval a maximálna spotreba pamäte sa pohybovala okolo 13.7 GB. To je
pozitívny signál, že veľkosť počas skladania zostala v medziach, v ktorých LatticeFold
dokáže pokračovať. Hoci ani tento výsledok neznamená pripravenosť na produkčné
dokazovanie Ethereum blokov, naznačuje, že dlhšie výpočty sú realizovateľné.

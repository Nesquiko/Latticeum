...
\newcommand{\FIITthesis}[0] {Engineer thesis}
...
\newcommand{\FIITtitleSK}[0] {Návrh riešení využívajúcich dôkazy s nulovou znalosťou v Ethereum ekosystéme}
\newcommand{\FIITauthor}[0] {Lukáš Častven}
\newcommand{\FIITsupervisor}[0] {Ing. Kristián Košťál PhD.}
\newcommand{\FIITevidenceNumber}[0] {FIIT-182905-116160}
\newcommand{\FIITdate}[0] {May 2026}
\newcommand{\FIITdateSK}[0] {Máj 2026}
...
\newcommand{\FIITdegreeCourseSK}[0] {FIIT-182905-116160}
...
\newcommand{\FIITsignDate}[0] {1.5.2026}
\newcommand{\FIITArchiveName}[0] {DP3\_LukasCastven.zip}
